...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        items.add(new ItemsList(R.mipmap.pikachu, "Pikachu", "Pikachu"));
        items.add(new ItemsList(R.mipmap.meowth, "Meowth", "Meowth"));
        items.add(new ItemsList(R.mipmap.psyduck, "Psyduck", "Psyduck"));
        items.add(new ItemsList(R.mipmap.bullbasaur, "Bullbasaur", "Bullbasaur"));
        items.add(new ItemsList(R.mipmap.squirtle, "Squirtle", "Squirtle"));
